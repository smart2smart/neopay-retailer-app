...
export const setRetailerProducts = (value: any) => {
  return {
    type: "SET_RETAILER_PRODUCTS",
    payload: value,
  };
};

export const setCartDraft = (value: any) => {
  return {
    type: "SET_CART_DRAFT",
    payload: value,
  };
...
export const removeRetailerCart = () => {
  return {
    type: "REMOVE_RETAILER_CART_NEW",
  };
};

export const clearCartCount = () => {
  return {
    type: "CLEAR_CART_UPDATE_COUNT",
  };
};
