...
import {setDistributorId, setIsLoggedIn} from "../../actions/actions";
...
import RetailersList from "../retailers-list/RetailersList";
import {BuildOrder} from "../build-order/BuildOrder";
...
export function CompanyList(props) {
    ...
    const [existingOrderData, setExistingOrderData] = useState([]);
    ...
    useEffect(() => {
        getProductsData();
        setExistingOrderData(route.params.existingOrderData);
    ...
    const getProductsData = () => {
        const dataToSend = {
            ...
            url: commonApi.getProducts.url + '?retailer_id=' + data.id + "&distributor_id=" + distributorId,
    ...
    const matchQuantities = (groupedData) => {
        ...
        existingOrderData.products.forEach((item) => {
...
export default connect(mapStateToProps, {setIsLoggedIn, setDistributorId})(CompanyList);
