...
function BuildOrder(props) {
  ...
  const __keyExtractor = (item, index) =>
    item.product_group_id + "" + item.product_group_name;

  return (
    <View
      style={{ flex: 1, paddingHorizontal: 12, backgroundColor: colors.white }}
    >
      <Indicator isLoading={loading} />
      <View style={commonStyles.rowSpaceBetween}>
        <SecondaryHeader
          headerRight={true}
          headerRightTitle={normalView ? "Detailed View" : "Normal View"}
          headerRightCta={toggleView}
          title={"Create Order"}
        />
      </View>
      <View
