      ...
      >
        <View>
          {image ? (
            ...
            <View style={commonStyles.imageContainer}>
              <Text style={texts.darkGrey18Bold}>Add storage image</Text>
              <TouchableOpacity onPress={goToUploadImage} style={style.addDiv}>
                <Text style={texts.redTextBold15}>+</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
        <View style={{ paddingHorizontal: 24 }}>
          <View style={{ paddingTop: 20 }}>
            <Text style={texts.redTextBold14}>{"Edit Details"}</Text>
          </View>
            ...
            {tabOptions.map((item) => {
              return (
                <TouchableOpacity
                  ...
                  key={item.key}
                  style={[commonStyles.rowSpaceBetween, style.tab]}
                >
                  <View>
                    <Text style={texts.darkGreyTextBold16}>{item.value}</Text>
                  </View>
