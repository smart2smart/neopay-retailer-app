    ...
    <View style={style.container}>
      ...
      <View style={commonStyles.columnSpaceBetween}>
          ...
          <View style={commonStyles.imageContainer}>
            {image ? (
              ...
              <View style={style.textDiv}>
                <Text style={texts.darkGrey18Bold}>Add store image</Text>
          ...
          <View>
            <View style={style.ctaContainer}>
              ...
              <TouchableOpacity
                ...
                style={[style.ctaDiv, style.borderBottom]}
              >
                <Text style={texts.greyTextBold14}>Capture with Camera</Text>
              ...
              <TouchableOpacity
                ...
                style={[style.ctaDiv, style.borderBottom]}
              >
                <Text style={texts.greyTextBold14}>Upload from Device</Text>
                <View style={style.iconDiv}>
                  <MaterialIcons
                    name="keyboard-arrow-right"
                    size={22}
              ...
              <View style={style.ctaDiv}>
                <Text style={texts.greyTextBold14}>Remove Photo</Text>
        ...
        <View style={style.buttonContainer}>
          <SolidButtonBlue
            text={"Save Image"}
            ctaFunction={goBackToPreviousScreen}
          />
        </View>
      </View>
    </View>
